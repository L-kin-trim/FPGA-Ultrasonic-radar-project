...
set rc [catch {
  open_project {DaChuang.prj}
  import_device eagle_s20.db -package EG4S20BG256
  import_db {../syn_1/DaChuang_gate.db}
  config_chipwatcher "../../DaChuang.cwc" -dir ""
  compile_watcher
  place
  export_db {DaChuang_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file DaChuang_phy.area
  export_db {DaChuang_pr.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid DaChuang_inst.bid
  bitgen -bit "DaChuang.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
